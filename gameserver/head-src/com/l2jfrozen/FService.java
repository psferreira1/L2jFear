...
public class FService
{
	...
	//gevorakos
	public static final String GEVOR_AKOC = "./config/gevorakoc/custom.properties";
	public static final String GEVO_RAKOC = "./config/gevorakoc/balance.properties";
	public static final String GEV_ORAKOC = "./config/gevorakoc/VoteReward.properties";
