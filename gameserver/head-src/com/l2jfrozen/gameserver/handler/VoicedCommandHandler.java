...
import com.l2jfrozen.gameserver.handler.voicedcommandhandlers.MultiFunction;
...
import com.l2jfrozen.gameserver.handler.voicedcommandhandlers.JoinOly;
...
import com.l2jfrozen.gameserver.handler.voicedcommandhandlers.menu1;
...
public class VoicedCommandHandler
{
	...
	private VoicedCommandHandler()
	{
		...
		registerVoicedCommandHandler(new menu1());
	    registerVoicedCommandHandler( new CastleManagersVCmd());
	    registerVoicedCommandHandler( new MultiFunction());
