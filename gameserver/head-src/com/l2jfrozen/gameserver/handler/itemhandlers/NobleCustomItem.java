...
public class NobleCustomItem implements IItemHandler
{
	...
	public void useItem(final L2PlayableInstance playable, final L2ItemInstance item)
	{
		if (Config.NOBLE_CUSTOM_ITEMS)
		{
			...
			{
				activeChar.sendPacket(new ExShowScreenMessage("You Are Already A Noblesse!.", 4000));
			}
			else
			{
				...
				activeChar.sendPacket(new ExShowScreenMessage("You Are Now a Noble,You Are Granted With Noblesse Status.", 4000));
