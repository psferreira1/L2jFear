...
replyMSG.append("<tr>");
replyMSG.append("<td><center><font color=\"ae9988\">Hey, want to change your password</font><center></td>");
replyMSG.append("</tr>");
...
replyMSG.append("<button value=\"Change Password\" action=\"bypass -h npc_" + getObjectId() + "_change_password $cur $new $repeatnew\" width=132 height=21 back=\"l2ceriel.bat\" fore=\"l2ceriel.bat\">");
replyMSG.append("<br>");
replyMSG.append("<br>");
replyMSG.append("<br>"); 
replyMSG.append("<img src=\"L2UI.SquareGray\" width=300 height=1>");
replyMSG.append("<table bgcolor=000000 width=319>");	
replyMSG.append("<tr>");
replyMSG.append("<td><center><font color=\"E80000\">L2Ryan.eu</font></center></td>");
replyMSG.append("</tr>");
replyMSG.append("</table>");
replyMSG.append("<img src=\"L2UI.SquareGray\" width=300 height=1>");
